...
const AblumModal = ({ albumInfo, showModal, setShowModal }) => {
  ...
  return (
    <div
      ...
      aria-modal="true"
    >
      <nav className="flex flex-col w-11/12 h-5/6 fixed top-0 bottom-0 left-0 right-0 m-auto pb-14 text-center z-99 bg-white rounded-md ">
        ...
        <article className="flex flex-col w-full h-full px-10">
          <div className="flex flex-row w-[300px] h-[200px]">
            <div className="fixed right-14 w-[194px] h-[194px] my-1 bg-gradient-to-r from-gray-600 to-black rounded-full " />
            <div className="fixed left-17 w-[200px] h-[200px]">
