...
for j in pageNums:
  url = "https://www.melon.com/artist/songPaging.htm?startIndex="+str(j)+"&pageSize=50&listType=F&orderBy=ISSUE_DATE&artistId=786648"
...
# 곡 상세정보 가져오기
for i in range(0, len(JoinSongsData)):
